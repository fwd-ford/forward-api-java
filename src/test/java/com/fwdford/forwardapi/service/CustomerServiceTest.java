...
class CustomerServiceTest {
    ...
    void setup() {
        ...
        Customer c = new Customer(TARGET_ID, "Jota", null, null, null, null, false, OffsetDateTime.now());
    ...
    void user_cannot_read_another_customer() {
        ApiException ex = assertThrows(ApiException.class,
                () -> service.get(TARGET_ID, OTHER_ID, "user"));
    ...
    void missing_customer_yields_not_found() {
        ...
        ApiException ex = assertThrows(ApiException.class,
                () -> service.get(TARGET_ID, TARGET_ID, "admin"));
