...
public class ApiException extends RuntimeException {
  ...
  public static ApiException unauthorized() {
    return new ApiException(
        HttpStatus.UNAUTHORIZED, "unauthorized", "Nao autenticado", "Token ausente ou invalido.");
  }

  public static ApiException forbidden() {
    return new ApiException(
        HttpStatus.FORBIDDEN, "forbidden", "Acesso negado", "Sem permissao para este recurso.");
  }
  ...
  public static ApiException payloadTooLarge() {
    return new ApiException(
        ...
        "payload_too_large",
        "Corpo da requisicao muito grande",
        "O conteudo excede o limite permitido.");
  }
